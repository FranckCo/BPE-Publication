...
public class DQV {
	...
	/* ##########################################################
	 * Defines DQV individuals
	   ########################################################## */
	public static final Resource qualityAssessment = model.createResource(uri + "qualityAssessment");
	public static final Resource precision = model.createResource(uri + "precision");
}